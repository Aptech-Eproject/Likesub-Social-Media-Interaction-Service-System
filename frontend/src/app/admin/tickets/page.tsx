                                    ...
                                    <tr key={ticket.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="py-3">
                                            <div className="flex items-center">
                                                ...
                                                <button className="p-2 transition-all border border-purple-500 hover:bg-[#846adf] hover:text-white hover:border-none cursor-pointer bg-white group duration-500">
